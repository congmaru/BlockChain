    ...
    <div class="container">
      ...
      <div id="my-item" class="row">
        ...
        <div v-else class="col-sm-12 col-md-8 mt-3">
          <div class="alert alert-warning">판매 거래가 없습니다.</div>
        </div>
        ...
        <div v-else class="col-sm-12 col-md-8 mt-3">
          <div class="alert alert-warning">구매 거래가 없습니다.</div>
        </div>
        ...
        <div v-else class="col-sm-12 col-md-8 mt-3">
          <div class="alert alert-warning">판매 상품이 없습니다.</div>
        </div>
      </div>
    </div>
  </div>
